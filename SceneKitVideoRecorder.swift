...
public class SceneKitVideoRecorder: NSObject, AVAudioRecorderDelegate {
    ...
    public func setupAudio() {
        ...
        do {
            ...
            try recordingSession.setCategory(AVAudioSession.Category.playAndRecord, mode: AVAudioSession.Mode.videoRecording, options: AVAudioSession.CategoryOptions.defaultToSpeaker)
